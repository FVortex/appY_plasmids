...
par(mfrow = c(2,2))
lwd = 0.2
matplot(e.coli_proms_bends, type = 'l', col = 1, lwd = lwd)
matplot(e.coli_non_proms_bends, type = 'l', col = 1, lwd = lwd)

matplot(b.subtilis_proms_bends, type = 'l', col = 1, lwd = lwd)
matplot(b.subtilis_non_proms_bends, type = 'l', col = 1, lwd = lwd)

ward_e.coli_proms_bends <- hclust.vector(t(e.coli_proms_bends), method = 'ward')
plot(ward_e.coli_proms_bends, labels = F)
...
for (i in unique(cut_e.coli_proms_bends)) {
  ...
  matplot(e.coli_proms_bends[,no], type = 'l', col = 1, lwd = 0.1, ylim = c(-1.5, 0.75))
}
...
get.phrasetable(ngram(str = 'pexpexpexppppexpppppp', n = 3, sep = ''))

#to find substrings on reverse strand, rev version is added

get.phrasetable(ngram(str = IRanges::reverse('pexpexpexppppexpppppp'), n = 3, sep = ''))
...
e.coli_b.subtilis_proms_ng6 <- ngram(str = paste0(c(unlist(e.coli_b.subtilis_non_proms), rev(unlist(e.coli_b.subtilis_non_proms))), collapse = ' '), n = 6)
e.coli_b.subtilis_non_proms_ng6 <- ngram(str = paste0(c(unlist(e.coli_b.subtilis_non_proms), rev(unlist(e.coli_b.subtilis_non_proms))), collapse = ' '), n = 6)


#better way to find oligos frequnces with biostrigs
all_seqs_oligos_freq <- c()
for (i in c(e.coli_proms, e.coli_non_proms, b.subtilis_proms, b.subtilis_non_proms)){
  tmp <- i
  
  tmp_StringSet <- DNAStringSet(sapply(t(tmp), function(x) {paste0(x, collapse = '')}))

all_seqs_oligos_freq <- cbind(all_seqs_oligos_freq, oligonucleotideFrequency(tmp_StringSet, 6, as.prob = T))
}
...
svg('/home/jane/Документы/Misha/mol_a_2018/all_mpots_both_bacteria.svg', width = 23, height = 15)
par(mfrow = c(2,2))
cex.main = 3
par(mfrow = c(2,2))
...
svg('/home/jane/Документы/Misha/mol_a_2018/all_bends_both_bacteria.svg', width = 23, height = 15)
par(mfrow = c(2,2))
cex.main = 3
par(mfrow = c(2,2))
